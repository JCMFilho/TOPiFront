import { __assign, __decorate, __metadata, __spread, __read, __param, __extends } from 'tslib';
...
var NGL_ICON_CONFIG = new InjectionToken('ngl-icon-config');
/**
...
/** Injection token that can be used to specify default options. */
var NGL_TOOLTIP_CONFIG = new InjectionToken('ngl-tooltip-config');
...
/** Injection token that can be used to specify default options. */
var NGL_COLORPICKER_CONFIG = new InjectionToken('ngl-colorpicker-config');
...
/** Injection token that can be used to specify default options. */
var NGL_COMBOBOX_CONFIG = new InjectionToken('ngl-combobox-config');
...
/** Injection token that can be used to specify default options. */
var NGL_DATEPICKER_CONFIG = new InjectionToken('ngl-datepicker-config');
...
/** Injection token that can be used to specify default options. */
var NGL_RATING_CONFIG = new InjectionToken('ngl-rating-config');
/**
